...
public class ListenerButtonSort implements ActionListener {
	public void actionPerformed(ActionEvent e)
	{
		final JFrame info_pane = new JFrame(); // Создание графического окна
		info_pane.setTitle("Отсортированный массив");
		...
		JLabel text = new JLabel(Arrays.deepToString(Sortir.BubbleS(ListenerButtonSozd.m)));
